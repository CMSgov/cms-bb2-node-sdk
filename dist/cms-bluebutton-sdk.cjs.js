...
function getAuthorizationToken(bb, authData, callbackRequestCode, callbackRequestState, callbackRequestError) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const resp = yield axios__default["default"].post(getAccessTokenUrl(bb), body, {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (let i = 0; i < retrySettings.maxAttempts; i++) {
            ...
            try {
                ...
                if (axios__default["default"].isAxiosError(error) && isRetryable(error)) {
                    resp = error.response;
                }
                else {
                    throw error;
...
function refreshAccessToken(authToken, bb) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const resp = yield axios__default["default"].post(tokenUrl, {}, {
            headers: {
