(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('fs'), require('process'), require('http'), require('https'), require('url'), require('stream'), require('assert'), require('zlib'), require('crypto')) :
    typeof define === 'function' && define.amd ? define(['fs', 'process', 'http', 'https', 'url', 'stream', 'assert', 'zlib', 'crypto'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global["cms-bluebutton"] = factory(global.fs, global.process$1, global.require$$1, global.require$$2, global.require$$0, global.require$$3, global.require$$4, global.require$$8, global.crypto));
})(this, (function (fs, process$1, require$$1, require$$2, require$$0, require$$3, require$$4, require$$8, crypto) { 'use strict';
