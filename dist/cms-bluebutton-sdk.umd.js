(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('fs'), require('process'), require('http'), require('https'), require('url'), require('stream'), require('assert'), require('zlib'), require('crypto')) :
    typeof define === 'function' && define.amd ? define(['exports', 'fs', 'process', 'http', 'https', 'url', 'stream', 'assert', 'zlib', 'crypto'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global["cms-bb2"] = {}, global.fs, global.process$1, global.require$$1, global.require$$2, global.require$$0, global.require$$3, global.require$$4, global.require$$8, global.crypto));
})(this, (function (exports, fs, process$1, require$$1, require$$2, require$$0, require$$3, require$$4, require$$8, crypto) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    function getAuthorizationToken(bb, authData, callbackRequestCode, callbackRequestState, callbackRequestError) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const resp = yield axios.post(getAccessTokenUrl(bb), body, {
    ...
    class BlueButton {
        ...
        normalizeConfig(config) {
            if (config.environment &&
                ...
                throw new Error(`Invalid environment: must be ${exports.Environments.PRODUCTION} or ${exports.Environments.SANDBOX}`);
            }
            return {
