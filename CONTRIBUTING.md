...
5.  From your branch, make a pull request against `CMSgov/cms-bb2-node-sdk/main`
6.  Work with repo maintainers to get your change reviewed
7.  Wait for your change to be pulled into `CMSgov/cms-bb2-node-sdk/main`
...
cms-bb2-node-sdk will see regular updates and new releases. This section describes the general guidelines around how and when a new release is cut.
...
cms-bb2-node-sdk uses [Semantic Versioning](https://semver.org/). Each release is associated with a [`git tag`](github.com/CMSgov/cms-bb2-node-sdk/tags) of the form `X.Y.Z`.
...
The following steps outline the process to prepare a Release Candidate of cms-bb2-node-sdk. This process makes public the intention and contents of an upcoming release, while allowing work on the next release to continue as usual in `dev`.
...
The following steps describe how to make an approved [Release Candidate](#preparing-a-release-candidate) an official release of cms-bb2-node-sdk:
...
[proj-releases-new]: https://github.com/CMSgov/cms-bb2-node-sdk/releases/new
-->
...
docs. Please file an [issue](https://github.com/CMSgov/cms-bb2-node-sdk/issues).
-->
